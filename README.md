...
[![NuGet](https://img.shields.io/nuget/v/LogBull.svg)](https://www.nuget.org/packages/LogBull/)
[![.NET Version](https://img.shields.io/badge/.NET-6.0+-blue.svg)](https://dotnet.microsoft.com/)

A .NET library for sending logs to [LogBull](https://github.com/logbull/logbull) - a simple log collection system.
...
- [Usage Examples](#usage-examples)
  ...
  - [2. Microsoft.Extensions.Logging Integration](#2-microsoftextensionslogging-integration)
  - [3. Serilog Integration](#3-serilog-integration)
